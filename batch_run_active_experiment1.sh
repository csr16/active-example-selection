...
# datasets=(sst-2) # sst-2 trec amazon winowhy epistemic_reasoning hyperbaton timedial aqua
...
#     sed -i "s/^seed: .*/seed: ${seed}/" "${temp_yaml}"
#     sed -i "s|^\(\s*load_transitions:\).*|\1 ./outputs/active/${dataset}_${seed}/ckpts/transitions_2000.ckpt|" "${temp_yaml}"
